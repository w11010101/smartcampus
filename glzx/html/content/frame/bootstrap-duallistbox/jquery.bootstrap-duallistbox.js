;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoTextFiltered: '<span class="label label-warning">筛选</span> {0} 项，总共 {1} 项', // when not all of the options are visible due to the filter
      infoTextEmpty: '显示 0 条',                                                        // when there are no options present in the list
